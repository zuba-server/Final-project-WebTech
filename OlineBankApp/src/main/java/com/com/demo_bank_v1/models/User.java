...
//    @Column(name = "user_id", nullable = false, columnDefinition = "BIGINT DEFAULT 1")
    ...
    public User(int user_id, String first_name, String last_name, String email, String password, int code, String token, LocalDate verified_at, LocalDateTime created_at, LocalDateTime updated_at) {
